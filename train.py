...
if __name__ == '__main__':
    ...
    parser.add_argument('--network_backbone', type=str,
    ...
    parser.add_argument('--trainset_filename', type=str, help='Train dataset filename',
                        default=trainset_filename_default)
    parser.add_argument('--valset_filename', type=str, help='Validation dataset filename',
    ...
    parser.add_argument('--trainset_augmented_filename', type=str, help='Train augmented dataset filename',
                        default=trainset_augmented_filename_default)
    parser.add_argument('--images_augmented_dir', type=str, help='Images augmented directory',
                        default=images_augmented_dir_default)
    parser.add_argument('--labels_augmented_dir', type=str, help='Labels augmented directory',
    ...
    train(network_backbone=network_backbone, pre_trained_model=argv.pre_trained_model,
          trainset_filename=trainset_filename, valset_filename=valset_filename, images_dir=images_dir,
          labels_dir=labels_dir, trainset_augmented_filename=trainset_augmented_filename,
          images_augmented_dir=images_augmented_dir, labels_augmented_dir=labels_augmented_dir, model_dir=model_dir,
          log_dir=log_dir)
